...
public interface TargetDAO extends BaseDAO {	
	 ...
	 * @return the page of results
	 */
	public Pagination search(int pageNumber, int pageSize, Long searchOid, final String targetName, final Set<Integer> states, final String seed, final String username, final String agencyName, final String memberOf, final boolean nondisplayonly, final String sortorder);
