				...
				new HibernateCallback() {
					public Object doInHibernate(Session session) {
						...
						query.createCriteria("site")
							 .add(Restrictions.ilike("title", aSiteTitle + "%"))
				...
				new HibernateCallback() {
					public Object doInHibernate(Session session) {
						...
						if(aCriteria != null && aCriteria.getTitle() != null && !"".equals(aCriteria.getTitle().trim())) {
							query.add(Restrictions.ilike("title", aCriteria.getTitle().trim() + "%"));
							cntQuery.add(Restrictions.ilike("title", aCriteria.getTitle().trim() + "%"));
						}
						
						if(aCriteria != null && aCriteria.getOrderNo() != null && !"".equals(aCriteria.getOrderNo().trim())) {
							query.add(Restrictions.ilike("libraryOrderNo", aCriteria.getOrderNo().trim() + "%"));
							cntQuery.add(Restrictions.ilike("libraryOrderNo", aCriteria.getOrderNo().trim() + "%"));
						}
						
						if(aCriteria != null && aCriteria.getAgentName() != null && !"".equals(aCriteria.getAgentName().trim())) {
							query.createCriteria("authorisingAgents").add(Restrictions.ilike("name", aCriteria.getAgentName().trim() + "%"));
							cntQuery.createCriteria("authorisingAgents").add(Restrictions.ilike("name", aCriteria.getAgentName().trim() + "%"));
						}
