...
public final class BandwidthCalculator {
	/** the logger. */
	private static Log log = LogFactory.getLog(BandwidthCalculator.class);
	 ...
	 */
	public static HashMap<Long, TargetInstance> calculateBandwidthAllocation(List<TargetInstance> aRunningTargetInstances, long aMaxBandwidth, int aMaxBandwidthPercent) {
