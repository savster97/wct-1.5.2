...
CREATE TABLE DB_WCT.REJECTION_REASON (RR_OID bigint not null, RR_NAME varchar(100) not null, RR_AVAILABLE_FOR_TARGET bit default 0 not null, RR_AVAILABLE_FOR__TI bit default 0 not null, RR_AGC_OID bigint not null, primary key (RR_OID));
