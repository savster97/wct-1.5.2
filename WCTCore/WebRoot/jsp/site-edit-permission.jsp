...
<table>
  ...
  <tr>
    ...
    <td class="subBoxText">
      <c:choose>
      	<c:when test="${editMode}">
	      <input type="text" name="startDate" value="<wct:date value="${command.startDate}" type="fullDate"/>" maxlength="10"><font color=red size=2>&nbsp;<strong>*</strong>&nbsp;</font>
	       to&nbsp;
	      <input type="text" name="endDate" value="<wct:date value="${command.endDate}" type="fullDate"/>" maxlength="10"><font size="1">&nbsp;dd/mm/yyyy</font>    
	    </c:when>
	    <c:otherwise>
	      <c:choose>
  ...
  <tr>
    ...
    <td class="subBoxText">
      <c:choose>
      	<c:when test="${editMode}"> 
	      <input type="text" name="openAccessDate" value="<wct:date value="${command.openAccessDate}" type="fullDate"/>" size="10" maxlength="10" />
	    </c:when>
	    <c:otherwise>
