...
<div id="searchBox">
	...
	<div id="searchBoxContent">
		...
		<tr>
			...
			<td class="searchBoxLabel">
				From:<br />
				<input type="text" name="<%=TargetInstanceCommand.PARAM_FROM%>" value="<wct:date type="fullDateTime" value="${command.from}"/>" maxlength="19" size="19" style="width:120px;" />
			</td>
			<td class="searchBoxLabel">
				To:<br />
				<input type="text" name="<%=TargetInstanceCommand.PARAM_TO%>" value="<wct:date type="fullDateTime" value="${command.to}"/>" maxlength="19" size="19" style="width:120px;" />
			</td>
			<td class="searchBoxLabel">
				Agency:<br />
