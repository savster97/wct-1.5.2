...
<div id="resultsTable">
	<table width="100%" cellpadding="2" cellspacing="0" border="0">
					...
					<tr>
						...
						<td width="70%">
						  ...
						  <c:choose>
						    ...
						    <c:otherwise>
						    | <a href="<c:out value="${archiveUrl}" escapeXml="false"/><c:out value="${seed.seed}"/>" target="_blank">Archives Harvested</a></td>
						    </c:otherwise>
						  </c:choose>
					</tr>
					<tr>			
		...
		<tr>
			<td width="30%"><a href="curator/tools/harvest-history.html?targetInstanceOid=<c:out value="${command.targetInstanceOid}"/>&harvestResultId=<c:out value="${command.harvestResultId}"/>">Harvest History</a></td>
