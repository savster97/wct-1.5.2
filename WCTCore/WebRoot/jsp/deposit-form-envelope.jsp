...
<a href="curator/target/target-instance.html?targetInstanceId=<c:out value="${command.targetInstanceID}&cmd=edit&init_tab=RESULTS"/>"><img src="images/generic-btn-cancel.gif" border="0" alt="Cancel"></a>
