...
<%@taglib prefix = "c" uri="http://java.sun.com/jsp/jstl/core"%>
		...
		<form name="registerUserForm" action="<%= Constants.CNTRL_CREATE_USER %>" method="POST">
		...
		<tr>
			<td class="subBoxText" colspan="2"><input type="hidden" name="<%= CreateUserCommand.PARAM_ACTION %>" value="<%= CreateUserCommand.ACTION_SAVE %>"> 			
			<c:choose>
				<c:when test="${command.mode == 'view'}">
