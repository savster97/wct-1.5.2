			...
			<span class="subBoxTitle">Annotations</span><br />
		 	<c:if test="${targetEditorContext.editMode}">
			  ...
			  <input id="alertable" type="checkbox" name="alertable" />&nbsp;Generate Alert?&nbsp;
	     	  <input id="btnAdd" type="image" src="images/subtabs-add-btn.gif" alt="Add" width="49" height="23" border="0" hspace="5" align="absmiddle" onclick="setAction(-1,'<%= TargetAnnotationCommand.ACTION_ADD_NOTE%>');">
