			...
			<table cellpadding="3" cellspacing="0" border="0">
			  ...
			  <tr>
			    ...
			    <td class="subBoxText">
			      <authority:showControl ownedObject="${groupEditorContext.targetGroup}" privileges="<%= Privilege.CREATE_GROUP %>" editMode="${editMode}">
			        <authority:show>
				      <input type="text" name="fromDate" value="<wct:date value="${command.fromDate}" type="fullDate"/>"  size="10" maxlength="10"/>
				    </authority:show>
				    <authority:dont>
			  ...
			  <tr>
			    ...
			    <td class="subBoxText">
			      <authority:showControl ownedObject="${groupEditorContext.targetGroup}" privileges="<%= Privilege.CREATE_GROUP %>" editMode="${editMode}">
			        <authority:show>
				      <input type="text" name="toDate" value="<wct:date value="${command.toDate}" type="fullDate"/>" size="10" maxlength="10"/>
				    </authority:show>
				    <authority:dont>
