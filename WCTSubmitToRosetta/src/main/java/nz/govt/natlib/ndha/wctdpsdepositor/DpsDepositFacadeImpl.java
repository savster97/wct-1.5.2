...
public class DpsDepositFacadeImpl implements DpsDepositFacade {
    ...
    private void setAdditionalDublinCoreElements(XPathWctMetsExtractor wctDataExtractor, Map<String, String> parameters) {
        ...
        wctDataExtractor.setAdditionalDCTermElement("accrualPeriodicity", parameters.get(DpsDepositFacade.DCTERMS_ACCRUAL_PERIODICITY));
        wctDataExtractor.setAdditionalDCTermElement("issued", parameters.get(DpsDepositFacade.DCTERMS_ISSUED));
    }
